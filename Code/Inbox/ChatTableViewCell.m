...
- (void)updateFramesForAuthorType:(AuthorType)type
{
    ...
    else
    {
        ...
        horizontal = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-30-[chatTimeLabel]-16-|" options:NSLayoutFormatDirectionLeftToRight metrics:nil views:NSDictionaryOfVariableBindings(chatTimeLabel)];
