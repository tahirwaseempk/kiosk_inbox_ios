...
extension Conversation {
    ...
    static func create(context: NSManagedObjectContext, contactId_: Int64, unreadMessages_: Bool, timeStamp_: Date, senderId_: Int64, chatId_: Int64, lastMessageId_: Int64, lastMessage_: String) -> Conversation {
    ...
    func update(contactId_: Int64, unreadMessages_: Bool, timeStamp_: Date, senderId_: Int64, chatId_: Int64, lastMessageId_: Int64, lastMessage_: String) {
